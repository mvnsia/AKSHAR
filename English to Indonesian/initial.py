...
def success():
    if request.method == 'POST':
        ...
        Temptext=open(f.filename,'r' , ).read()
        HindiText = translator.translate(Temptext,'id')
        text = HindiText.text
        open('temp.txt','w', encoding='utf-8').close()
        HindiTextFile = open('temp.txt','w', encoding='utf-8')
